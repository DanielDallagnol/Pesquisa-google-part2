...
import { BotaoLog } from "./assets/Buttons/BotaoChamaLog"
import { BotaoPost } from "./assets/Buttons/BotaoFazPost"

function App() {

  const chamaConsoleLog = () => {
    BotaoLog();
  };
...
<Box
    ...
    >
      ...
      react-router-dom 
      criar um router em react
      com on-change que faça um post
      

      <CriaForm/>

      <Stack spacing={2} direction="row">
        <Button onClick={chamaConsoleLog} texto='pesquisa google'/>
        <Button onClick={fazPost} texto='estou com sorte'/>
      </Stack>
